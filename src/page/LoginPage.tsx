    ...
    <div style={{marginLeft:"60px"}} className='flex' >
      ...
      <div className='w-2/4 h-2/4 m-50 items-center flex-col flex justify-center center p-20 bg-grey rounded-lg'>
        <div className=' justify-center flex flex-col w-80' >
          <label className=' text-background flex flex-col' htmlFor='email'><p className='mb-2'>이메일</p>
          ...
          <label className='text-background flex flex-col mt-5 pb-1' htmlFor='password'><p className='mb-2'>비밀번호</p>
        ...
        <img style={{position:'absolute',top:'-2px',left:'14px',zIndex:'1'}} src={Enter} alt="pencil" />
          <button type='button' className=' rounded-xl border-none bg-[#677DC6] w-36 mr-4 drop-shadow-lg px-14 pr-4 py-2.5  text-white font-semibold  bg-button-500' >Login</button> 
          <img style={{position:'absolute',top:'-2px',right:'110px',zIndex:'1'}} src={Enter} alt="pencil" />
          <button type='button' className='rounded-xl border-none bg-[#677DC6]  w-36 ml-4 drop-shadow-lg px-14 pr-4 py-2.5 text-white font-semibold  bg-button-500'>Sign In</button> 
        </div>
      </div>
      </div>
)
