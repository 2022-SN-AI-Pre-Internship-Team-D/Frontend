...
function MyPage() {
    ...
    <div 
    className=' pt-20 bg-[#0E1733] flex justify-center h-[60rem] items-center'>
        
        <div className=' text-white border-solid border-2 rounded-lg w-4/6 h-4/5 flex flex-col items-center justify-center'>

        <img style={{position:'absolute',top:'10px'}} className='scale-75 object-fit:cover text-white border-2 rounded-full' src={userprofile} alt="유저사진" />
        ...
        <button type='button' className='font-press-start mt-10'>Account Settings</button>
    </div>
    </div>
    )
}
